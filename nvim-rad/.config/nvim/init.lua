...
vim.pack.add({
	...
	-- We will install LSPs with Mason
	"https://github.com/mason-org/mason.nvim",
	-- Linters and formatters management to complement language servers
	-- efmls itself is a language server
